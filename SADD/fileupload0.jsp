...
String sql="select fileid from cloud where clientid='"+uname+"' and filehash='"+hash+"'";
System.out.println("sql="+sql);
rs = stmt.executeQuery("select fileid from cloud where clientid='"+uname+"' and filehash='"+hash+"' ");
...
if(i>0){
response.sendRedirect("fileupload.jsp?msg3=sendtoauditor");
}else{
response.sendRedirect("fileupload.jsp?msg4=sendtoauditorfail");
}
}
%>
