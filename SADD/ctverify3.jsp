...
if(b3.equals(b33))
	...
	<%
			...
			status3=false;
				%>
	<tr><td>	<h2><font size="" color="red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;File Block2 Verified,  Modyfied .</font></h2><br>
		<%}%>
	

	<%  if(status2==true){
	%>
	<tr><td><h2><font size="" color="#00cc33">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;File Block3 Verified, not Modyfied .</h2></font>
	<%
	}
		else{
			status3=false;
...
<%if(status3==false){
	%>
<center><form method="post" action="ctverify4.jsp">
