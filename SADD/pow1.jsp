...
<tr>
	<td><strong><font size="3" color="red">Privilege Key</strong></td><td><input type="text" name="pkey"></td><td><a href="getKey1.jsp?uid=<%=uname%>"><font size="3" color="green"><h4>GetKey</h4></a></td>
