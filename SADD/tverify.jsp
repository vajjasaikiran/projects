...
Connection con=databasecon.getconnection();
	...
	while(rs.next())	
	 {%>
	 <tr bgcolor="#1bcf8b"><td><font size="3" color="white"><h1><%=rs.getString(1)%><td><font size="3" color="white"><h1><%=rs.getString(7)%><td><a href="tverify2.jsp?id=<%=rs.getString(1)%>&cid=<%=rs.getString(7)%>"><font size="3" color="white"><h1>View</a>
	 <%
	}
  }
  catch(Exception e){
