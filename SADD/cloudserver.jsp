...
<!-- about -->
	<div class="forms" align="center">
					<form action="cloudvalidation.jsp" method="post">
					<table>
					<tr><td><font color="orange" size="6"><b>CloudServer Login</u></b></font></td></tr>
					<tr><td><br></td></tr>
					<tr><td><!-- <font color="gray" size="5"><b>User Name:</b></font> --></td><br></tr>
