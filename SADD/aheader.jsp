...
<body>
	...
	<a href='#'><img src="images/logo.png" width="150" height="70" border="0" alt=""></a>
				...
				<div class='eleven columns'>
					<ul class='mainMenu'>
							<li class="active"><a href="auditorhome.jsp" data-hover="Home"><h1>Home</a></li>
					<li><a href="viewrequest.jsp" data-hover="FileUpload"><h1>FileUpload</a></li>
					<li><a href="tverify.jsp" data-hover="DataIntegrity"><h1>DataIntegrity</a></li>
							<!-- 	<li><a href="viewverify1.jsp" data-hover="AuditResult">AuditResult</a></li> 
