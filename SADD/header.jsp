		...
		<nav>
			<div class='container'>
				...
				<div class='eleven columns'>
					<ul class='mainMenu'>
						<li class="active"><a href="index.html" data-hover="Home"><h1>Home</a></li>
					<li><a href="cloudclient.jsp" data-hover="Cloud Client"><h1>Cloud Client</a></li>
					<li><a href="auditor.jsp" data-hover="Auditor"><h1>Auditor</a></li>
					<li><a href="cloudserver.jsp" data-hover="Cloud Server"><h1>Cloud Server</a></li>
					<li><a href="contact.jsp" data-hover="Contact"><h1>Contact</a></li>
					</ul>
				</div>
			</div>
		</nav>
