...
String sss1 = "select *from cloud where stats='SecCloud' ";
ResultSet rs=st1.executeQuery(sss1);
%>
<table cellspacing="20">
<tr><td><h2><font size="" color="#eb6705">File ID</h2><td><h2><font size="" color="#eb6705">File Name</h2><td><h2><font size="" color="#eb6705">File Blocks</h2><br></tr>
<%
while(rs.next())
{
%>
